...
const HeroBanner = () => {
    return (
        ...
        <div className=' z-0 w-full h-screen flex justify-center items-center  bg-[url("/images/home.jpg")] bg-fixed bg-center bg-cover md:bg-[length:full_100%] max-h-screen '>
