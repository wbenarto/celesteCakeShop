    ...
    <>
      ...
      <div className='bg-[url("/images/pinkwave.svg")] bg-no-repeat sm:bg-repeat object-cover flex-column md:gap-4 h-[48rem] sm:h-[42rem]  overflow-hidden md:mx-auto md:justify-center md:flex md:px-32'>
        ...
        <div className='my-auto px-6 md:px-0 md:w-full mx-auto py-12 justify-center'>
          <h1 className='font-mont text-2xl text-white font-semibold text-left md:text-4xl'>We offer Custom Designed Cakes for every occasion</h1>
      ...
      <div className=' bg-[#f5b2ca] flex-column md:gap-4 h-[38rem] sm:h-[42rem]  overflow-hidden md:mx-auto md:justify-center md:flex md:px-32'>
        ...
        <div className='px-2 h-1/1 md:w-full md:h-full thirdCircle overflow-x-scroll flex items-center gap-2 md:justify-center'>
          <div className=' h-[20rem] min-w-[14rem] md:w-[20rem] md:h-[26rem] rounded-md p-2 md:p-2 bg-white '>
