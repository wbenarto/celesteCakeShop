...
const custom = () => {
  ...
  return (
    <div className='grid w-full absolute mt-20 mx-auto px-4  sm:px-14 md:px-24 lg:px-48'>
        <h1 className=' p-4 border-b-2 font-hero border-gray-500 text-gray-500 rounded-md text-center font-bold text-xl'>Custom Cake Order</h1>
