  ...
  return (
    <div className=''>
      ...
      {/* <div className='bg-[url("/images/bday1.jpg")] bg-fixed bg-cover bg-center bg-no-repeat w-full h-screen '></div> */}
        ...
        <div className='flex-row my-2 py-5 md:my-20 h-[20rem] px-4 gap-4 md:gap-14 md:px-20 lg:px-32 md:h-[600px]  '>
          ...
          <div className='w-3/4  relative mt-24 float-right bg-white p-4  '>
      ...
      <div className='md:my-20 h-[24rem] md:h-[36rem] text-center mx-auto md:max-w-[1200px]'>
        ...
        <h2 className='relative text-[#324d67] pt-14 md:pt-8 md:pb-4 text-lg  font-hero md:text-4xl'>Other Baked Goods</h2>
